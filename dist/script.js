...
const dataGerman = [
    {
        info: '<details class="word group"> <summary>der Bedarf</summary><br> <p class="text"> Es gibt großen Bedarf an Wohnungen in der Stadt. <span>(etwas, das man braucht.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>durchführen</summary><br> <p class="text"> Wir führen heute einen Test durch. <span>(etwas machen oder organisieren.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>heranführen an</summary><br> <p class="text"> Die Lehrerin führt die Kinder an Musik heran. <span>(jemandem etwas Neues zeigen oder erklären.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>konzipieren</summary><br> <p class="text"> Die Architekten konzipieren ein neues Haus. <span>(einen Plan machen oder etwas entwerfen.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>das Phänomen</summary><br> <p class="text"> Ein Regenbogen ist ein schönes Phänomen. <span>(etwas, das man beobachten kann und oft besonders ist.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>die Scheu</summary><br> <p class="text"> Das Kind hat Scheu vor fremden Menschen. <span>(das Gefühl, wenn man Angst hat oder sehr vorsichtig ist.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>überlebenswichtig</summary><br> <p class="text"> Wasser ist überlebenswichtig für Menschen. <span>(etwas, das man unbedingt zum Leben braucht.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>verschärfen</summary><br> <p class="text"> Die Regeln werden verschärft. <span>(etwas wird schlimmer oder stärker.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>abstrakt</summary><br> <p class="text"> Das Bild ist sehr abstrakt. <span>(etwas, das nicht direkt sichtbar oder schwer zu verstehen ist.)</span> </p> </details>',
    },
    {
        info: '<details class="word group"> <summary>bewerten</summary><br> <p class="text"> Der Lehrer bewertet die Hausaufgaben. <span>(sagen, wie gut oder schlecht etwas ist.)</span> </p> </details>',
    },
    {
